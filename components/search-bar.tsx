  ...
  return (
    <form onSubmit={handleSubmit} className={`relative ${className}`}>
      ...
      <Input
        ...
        className="pl-12 pr-4 py-3 text-lg border-2 border-white/30 focus:border-primary rounded-full bg-white/90 backdrop-blur-sm text-gray-900 placeholder:text-gray-600"
      />
      <Button
        type="submit"
