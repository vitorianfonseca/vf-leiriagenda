  ...
  return (
    <div className={`relative ${className}`}>
      <Avatar className={sizeClasses[size]}>
        ...
        <AvatarFallback className="bg-[#D4AF37] text-white text-2xl">{fallbackText}</AvatarFallback>
      </Avatar>
      ...
      {!disabled && (
        <Button
          ...
          className={`absolute -bottom-2 -right-2 rounded-full ${buttonSizeClasses[size]} p-0 bg-[#D4AF37] hover:bg-[#B8941F]`}
        >
          {isUploading ? (
